...
//\//////////////////////////////////////////////////////////////////////////////////
// Scantron Custom Code follows...
//\//////////////////////////////////////////////////////////////////////////////////

var varPopUpText;
varPopUpText = "sample text"
var popTimeOut
function funPopUp(id,type){
popTimeOut = null;
varPopUpText = ""
varPopUpTitle = ""
	if(type == "instruct"){
		varPopUpTitle = '<nobr><span class="PopUpHeader"><span class="ss2b">Targeted Instruction&nbsp;&nbsp;&nbsp;&nbsp;</span></span></nobr>'
		//varPopUpText = varPopUpText + '<table  border="0" cellspacing="0" cellpadding="1"><tr><td align="center" valign="middle" nowrap="nowrap"><img src="/images/bltPopUp.gif" name="popImage1" id="popImage1" width="4" height="7" /></td><td width="100%" align="left" valign="top" nowrap="nowrap" class="PopUpText"><a href="/skills/create/create.ssp"><span class="PopUpText"><span class="ss2">&nbsp;Assessment</span></span></a></td></tr></table>'     // Bug #12382
		varPopUpText = varPopUpText + '<table  border="0" cellspacing="0" cellpadding="1"><tr><td align="center" valign="middle" nowrap="nowrap"><img src="/images/bltPopUp.gif" name="popImage1" id="popImage1" width="4" height="7" /></td><td width="100%" align="left" valign="top" nowrap="nowrap" class="PopUpText"><span class="PopUpText"><span class="ss2">&nbsp;Assessment</span></span></a></td></tr></table>'                                           // Bug #12382
		//varPopUpText = varPopUpText + '<table  border="0" cellspacing="0" cellpadding="1"><tr><td align="center" valign="middle" nowrap="nowrap"><img src="/images/bltPopUp.gif" name="popImage1" id="popImage1" width="4" height="7" /></td><td width="100%" align="left" valign="top" nowrap="nowrap" class="PopUpText"><a href="/TODO:_NEED_LINK" onMouseOver="funPopUpImage(\'1\',\'over\')" onMouseOut="funPopUpImage(\'1\',\'out\')"><span class="PopUpText"><span class="ss2">&nbsp;Resources</span></span></a></td></tr></table>'
	}
return overlib(varPopUpText,CLOSECOLOR,'FFFFFF',STICKY,HAUTO,VAUTO, CAPTION,varPopUpTitle,BORDER, 2,CSSCLASS, FGCLASS,'PopUpFGSCOL',BGCLASS,'PopUpBKSCOL',CLOSETEXT,'<span class="PopUpHeaderClose"><span class="ss2b">X</span></span>');
}
