...
insert into learning_standards (id,ref_id,progression,levels) values ('k.cc.b.4a','7B20214AA4AA445AA720062C6F1B5C58',4,3);
insert into learning_standards (id,ref_id,progression,levels) values ('k.cc.b.4b','3DEE205D86BC461FA4271EF4BD190A0C',5,3);
insert into learning_standards (id,ref_id,progression,levels) values ('k.cc.b.5','6F4455B55B4240F3B4738DD9DB3EAF40',6,1);
insert into learning_standards (id,ref_id,progression,levels) values ('k.cc.c.6','66626D8AEE4E474B8CFEC8A4B68AA51C',7,1);
insert into learning_standards (id,ref_id,progression,levels) values ('k.cc.c.7','C9B9CAD5BDE84CE2A7A0C441A3DF1A2D',8,1);
insert into learning_standards (id,ref_id,progression,levels) values ('k.oa.a.1','C815B29CD8F546BBBB4C647B9D163942',9,20);
insert into learning_standards (id,ref_id,progression,levels) values ('k.oa.a.2','695A7607FE8A4E27AB80652C45C84FA8',10,1);
insert into learning_standards (id,ref_id,progression,levels) values ('k.oa.a.3','9EC218587C01452C9EB49F52EB2DD1DD',11,10);
...
insert into learning_standards (id,ref_id,progression,levels) values ('k.g.b.4','C712BAA86FEF4BFAB703AD2EB402B2DE',21,1);
insert into learning_standards (id,ref_id,progression,levels) values ('1.oa.a.1','C712BAA86FEF4BFAB703AD2EB402B2DD',101,10);
...
insert into learning_standards (id,ref_id,progression,levels) values ('1.oa.c.5','2688E9D1A3FA4B689A3D9E41A1071C0E',105,2);
insert into learning_standards (id,ref_id,progression,levels) values ('1.oa.c.6','6C33D2BEC1AC431C8FC4BF9FD4DD3DCA',106,79);
insert into learning_standards (id,ref_id,progression,levels) values ('1.oa.d.7','2A26EE660F72412EA29765D79C367F0B',107,3);
insert into learning_standards (id,ref_id,progression,levels) values ('1.oa.d.8','626EB1B1473A47E28445F7E8DBDDC269',108,3);
insert into learning_standards (id,ref_id,progression,levels) values ('1.nbt.a.1','19A6BEFD554245118E73E9D4E6048E30',109,6);
insert into learning_standards (id,ref_id,progression,levels) values ('1.nbt.b.2','0B8F8764427D4A1D9FE9EBA6D2EC0C95',110,3);
insert into learning_standards (id,ref_id,progression,levels) values ('1.nbt.b.3','C20A87396FC74159818466765D45D084',111,1);
insert into learning_standards (id,ref_id,progression,levels) values ('2.oa.b.2','800715566B824BB3A5A8C464E961C2B4',112,304);
insert into learning_standards (id,ref_id,progression,levels) values ('3.oa.c.7','3D384CB2349B41299A3B5A133AB9E3F8',113,218);
