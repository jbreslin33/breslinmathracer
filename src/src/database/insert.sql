...
insert into learning_standards (id,core_standards_id,progression,levels) values ('g4.nbt.a.1','g4.nbt.a.1',4,4); 
insert into learning_standards (id,core_standards_id,progression,levels) values ('g4.nbt.a.2','g4.nbt.a.2',5,4); 
insert into learning_standards (id,core_standards_id,progression,levels) values ('evaluation','evaluation',10000,4); 
