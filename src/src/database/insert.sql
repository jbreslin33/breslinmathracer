...
insert into core_subjects(id,descriptions) values (1,'Math'); 
insert into core_subjects(id,descriptions) values (2,'ELA'); 

insert into core_grades(id,descriptions) values (1,'k'); 
insert into core_grades(id,descriptions) values (2,'1'); 
