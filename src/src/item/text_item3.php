...
setUserAnswer3: function(userAnswer)
{
...
showCorrectAnswer: function()
{
	if (this.mCorrectAnswerLabel)
	{
	  	...
	  	this.mCorrectAnswerLabel.setText('CORRECT ANSWER: ' + this.mHeadingAnswerLabel.getText() + ' ' +  this.getAnswer()  + ' ' + this.mHeadingAnswerLabel2.getText() + ' ' +  this.getAnswer(1) + ' ' + this.mHeadingAnswerLabel3.getText() + ' ' +  this.getAnswer(2)); 
