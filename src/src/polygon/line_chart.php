...
*/
 ...
 b = this.mRaphael.circle(this.startX + (pointX*29.08), this.startY, 10).scale(.25,.25);

circleX[j] = this.startX + (pointX*29.08);
//circleY[j] = 
...
var q = this.mRaphael.path(['M', circleX[0], this.startY, 'H', circleX[1]]).attr({
        stroke : 'green',"stroke-width":3
    }).toBack();

/*
this.arrow = new Shape(100,50,100,300,game,"","","");
this.arrow.mMesh.setStyle('color', 'blue');
this.arrow.setText(">");
*/
...
if(dir == 'right')
{
   v = this.startX + (10.5*29.08);

   q = this.mRaphael.path(['M', circleX[0], this.startY, 'H', v]).attr({
        stroke : 'green',"stroke-width":3
    }).toBack();

   this.arrow = new Shape(100,50,v+53,this.startY+50,game,"","","");
   item.addQuestionShape(this.arrow);
   this.arrow.mMesh.setStyle('color', 'green');
   this.arrow.mMesh.style.fontWeight = "900";
   this.arrow.setText(">");
...
{
   v = this.startX + (-1*9.08);

   q = this.mRaphael.path(['M', circleX[0], this.startY, 'H', v]).attr({
        stroke : 'green',"stroke-width":3
    }).toBack();

   this.arrow = new Shape(100,50,v+57,this.startY+50,game,"","","");
   item.addQuestionShape(this.arrow);
   this.arrow.mMesh.setStyle('color', 'green');
   this.arrow.mMesh.style.fontWeight = "900";
