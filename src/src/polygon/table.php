//x,y table
var Table3 = new Class(
{
Extends: RaphaelPolygon,
        initialize: function (game,item,raphael,x1,y1,x2,y2,table,rX1,rY1,tableData,tweakX,tweakY,s,d)
        {
...
for (var i = 0; i < rows-1; i++) {
    ...
    if (i == 0)
       y = tableY + rowHeight; // headings are bigger
    else
       y = tableY + rowHeight;
...
var y = tableY+rY1+(rowHeight/2);
var x = tableX+rX1+(colWidth/2);
...
for (var i = 0; i < rows; i++) {
  ...
  for (var j = 0; j < cols; j++) {
        ...
        posX = x+(j*colWidth)+tweakX;
        posY = y+(i*(rowHeight))-tweakY;
