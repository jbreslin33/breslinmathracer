var NameMachine = new Class(
{
		...
		this.mBoyNameArray.push("James"); 
		this.mBoyNameArray.push("Bryan"); 
		this.mBoyNameArray.push("Richel"); 
		this.mBoyNameArray.push("Nick"); 
		this.mBoyNameArray.push("Carlos"); 
		this.mBoyNameArray.push("Julio"); 
		this.mBoyNameArray.push("Ethan"); 
		this.mBoyNameArray.push("Keylin"); 
		this.mBoyNameArray.push("Omar"); 
		this.mBoyNameArray.push("Christian"); 
		this.mBoyNameArray.push("Joseph"); 
		this.mBoyNameArray.push("Alexander"); 
		this.mBoyNameArray.push("Jack"); 
		this.mBoyNameArray.push("Ahmir"); 
		this.mBoyNameArray.push("Edwin"); 
		this.mBoyNameArray.push("Quan"); 
		this.mBoyNameArray.push("Erik"); 
		this.mBoyNameArray.push("Brandon"); 
		this.mBoyNameArray.push("Kenneth"); 
		this.mBoyNameArray.push("Aldo"); 
		this.mBoyNameArray.push("Luis"); 
		this.mBoyNameArray.push("Jovon"); 

		
		this.mGirlNameArray.push("Kimora"); 
		this.mGirlNameArray.push("Angelis"); 
		this.mGirlNameArray.push("Mya"); 
		this.mGirlNameArray.push("Milani"); 
		this.mGirlNameArray.push("Rachel"); 
		this.mGirlNameArray.push("Astrid"); 
		this.mGirlNameArray.push("Lamanh"); 
		this.mGirlNameArray.push("Sharon"); 
		this.mGirlNameArray.push("Kayleis"); 
		this.mGirlNameArray.push("Isabel"); 
		this.mGirlNameArray.push("Tamthi"); 
		this.mGirlNameArray.push("Genesis"); 
		this.mGirlNameArray.push("Lilly"); 
		this.mGirlNameArray.push("Jada"); 
		this.mGirlNameArray.push("Imani"); 
		this.mGirlNameArray.push("Dasha"); 
		this.mGirlNameArray.push("Jaslin"); 
		this.mGirlNameArray.push("Lyanelys"); 
		this.mGirlNameArray.push("Samantha"); 
