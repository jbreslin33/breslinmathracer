...
var Evaluation = new Class(
{
	initialize: function()
		...
		this.mStateMachine = new StateMachine(this);
                ...
                this.mGLOBAL_EVALUATION                 = new GLOBAL_EVALUATION        (this);
                this.mINIT_EVALUATION                   = new INIT_EVALUATION          (this);
                this.mNORMAL_EVALUATION                 = new NORMAL_EVALUATION        (this);
                this.mGET_LEVEL_DATA_EVALUATION         = new GET_LEVEL_DATA_EVALUATION (this);
                this.mADVANCE_TO_NEXT_LEVEL_EVALUATION  = new ADVANCE_TO_NEXT_LEVEL_EVALUATION (this);
                this.mREWIND_TO_PREVIOUS_LEVEL_EVALUATION  = new REWIND_TO_PREVIOUS_LEVEL_EVALUATION (this);

                this.mStateMachine.setGlobalState(this.mGLOBAL_EVALUATION);
                this.mStateMachine.changeState(this.mINIT_EVALUATION);
