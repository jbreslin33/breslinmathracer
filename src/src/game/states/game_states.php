...
/****************** ***********************/
/****************** ********* ************/
var GLOBAL_GOBBLE_GAME = new Class(
{
Extends: State,
...
var INIT_GOBBLE_GAME = new Class(
{
Extends: State,
...
execute: function(game)
{
        game.mGobbleStateMachine.changeState(game.mRESET_GOBBLE_GAME);
},
...
var RESET_GOBBLE_GAME = new Class(
{
Extends: State,
...
enter: function(game)
{
        //this.log('RESET_GOBBLE_GAME');
        game.reset();
        game.mGobbleStateMachine.changeState(game.mNORMAL_GOBBLE_GAME);
},
...
var NORMAL_GOBBLE_GAME = new Class(
{
Extends: State,
...
execute: function(game)
{
	if (game.mDoor.mEnteredDoor == true)
	{
        	game.mGobbleStateMachine.changeState(game.mLEVEL_PASSED_GOBBLE);
	}
},
...
var LEVEL_PASSED_GOBBLE = new Class(
{
Extends: State,
...
execute: function(game)
{
	//just wait here until what???
        if (game.mApplication.mAdvanceToNextLevelConfirmation)
        {
                game.mGobbleStateMachine.changeState(game.mINIT_GOBBLE_GAME);
        }
