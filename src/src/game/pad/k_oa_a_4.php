...
Extends: Pad,
	...
	createQuestions: function()
		...
		//add
                ...
                this.mQuiz.mQuestionPoolArray.push(new Question('3 + ? = 10','7'));
                this.mQuiz.mQuestionPoolArray.push(new Question('2 + ? = 10','8'));
                this.mQuiz.mQuestionPoolArray.push(new Question('1 + ? = 10','9'));
		//9
