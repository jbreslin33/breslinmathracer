...
Extends: NumberPad,
	...
	createQuestions: function()
		...
		if (this.mApplication.mLevel < 11)
		{
			...
			var question = new QuestionWord('','',2,9,2,9,2,9,0,0,'Chris had a rectangular backyard with a length of','feet and a width of', 'feet. What is the perimeter of his yard?','',9);	
			question.mTipArray[0] = 'P=2(Length+Width)';
                        this.mQuiz.mQuestionArray.push(question);
