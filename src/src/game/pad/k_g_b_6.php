...
Extends: MultipleChoicePad,
	...
	initialize: function(application)
	{
		...
		this.mRedTriangle.mPolygon.drag  (this.mRedTriangle.move, this.mRedTriangle.start, this.mRedTriangle.up);                
		this.mGreenTriangle.mPolygon.drag(this.mGreenTriangle.move, this.mGreenTriangle.start, this.mGreenTriangle.up);                
	},
