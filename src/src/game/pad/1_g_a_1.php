...
Extends: MultipleChoicePad,
	...
	createQuestions: function()
		...
		if (this.mApplication.mLevel < 11)	
		{
			...
			var question = new Question('This has three sides, is it a triangle?', 'no');
	...
	createWorld: function()
	{
		...
		if (this.mApplication.mLevel < 11)	
		{
			this.mShapeArray.push(new LineOne   (this,this.mRaphael,300,300,350,250,350,300,.3,1,1,"none",.5,true)); 
