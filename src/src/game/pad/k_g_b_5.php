...
Extends: Pad,
	...
	initialize: function(application)
	{
		...
		this.mRedTriangle     = new Triangle (this,this.mRaphael,0,150,0,100,50,100,0,1,1,"none",.5,true); 
		this.mGreenTriangle   = new Triangle (this,this.mRaphael,100,150,150,100,150,150,.3,1,1,"none",.5,true); 
		this.mBlueTriangle    = new Triangle (this,this.mRaphael,200,150,250,100,300,150,.6,1,1,"none",.5,true); 
