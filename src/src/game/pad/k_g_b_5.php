...
Extends: Game,
	...
	initialize: function(application)
	{
		...
		this.mRedTriangle  = new Triangle (this.mRaphael,100,150,150,100,200,150,0,1,1,"none",.5); 
		this.mRedTriangle  = new Triangle (this.mRaphael,200,150,250,100,300,150,0,1,1,"none",.5); 
		this.mRedTriangle  = new Triangle (this.mRaphael,300,150,350,100,400,150,0,1,1,"none",.5); 
