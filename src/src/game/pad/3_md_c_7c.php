...
Extends: RulerPad,
	...
	createQuestions: function()
		...
		for (i = 0; i < this.mScoreNeeded; i++)
		{
			...
			var question = new Question('Find the area of the red and blue rectangles and show that you can use the distributive property to solve. Example Answer: 20,4(3+2)', parseInt(totalHeightCode * (redWidthCode + blueWidthCode)) + ',' + totalHeightCode + '(' + redWidthCode + '+' + blueWidthCode + ')');
