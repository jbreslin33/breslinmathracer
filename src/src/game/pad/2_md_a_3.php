	...
	createQuestions: function()
		...
		for (i = 0; i < this.mScoreNeeded; i++)
		{
			...
			if (randomNumber == 0)
			{
				...
				question = new Question('Estimate the length of the red shape in centimeters? Write answer like this: 10 cm', '' + answer);
				...
				if (randomEstimate == 0)
				{
					this.mRectangleArray[i].setSize(50,parseInt(redHeight + 5));
				}
				else
				{
					this.mRectangleArray[i].setSize(50,parseInt(redHeight - 5));
			...
			else
			{
				//get random heights.
                        	...
                        	question = new Question('Estimate the length of the red shape in inches? Write answer like this: 10 in', '' + answer);
                        	this.mQuiz.mQuestionArray.push(question);
