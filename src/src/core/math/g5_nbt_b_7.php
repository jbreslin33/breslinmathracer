...
process:  function()
{
	...
	else //lets split it
	{
		...
		var decimalPart = s.substring(parseInt(s.length - this.mDecimalPlaces),parseInt(s.length - 1));	
...
initialize: function(sheet)
{
	...
	while (this.part == 0)
	{
        ...
        if (this.part > 99999) // we are 6 digits
        {
                ...
                else if (this.part % 10000 == 0) // we have a multiple of 10,000 1
                {
                        var tens = parseInt(this.part / 100000);
			...
			ones = parseInt(ones / 10000);
                ...
                else if (this.part % 1000 == 0) // we have a multiple of 1,000 1
                {
                        var tens = parseInt(this.part / 100000);
			...
			tenths = parseInt(tenths / 1000);
                ...
                else if (this.part % 100 == 0) // we have a multiple of 100 1
                {
                        var tens = parseInt(this.part / 100000);
	...
	else if (this.part > 9999) // we are 5 digits
        {
	...
	else if (this.part > 99) // we are 3 digits 
	{
        	...
        	else // we have pure 3 digit number  
		{
			...
			var tenthousandths = this.part % 10;  
                	...
                	this.answer = '0.0' + hundredths + thousandths + tenthousandths;
		}
	}
        else if (this.part <= 99) // 2 digits 
        {
