...
getItem: function(id)
{
	...
	if (id == 'k.cc.a.3_5')
	{
		return new i_k_cc_a_3__5(this.mSheet);
	}
	if (id == 'k.cc.a.3_6')
	{
		return new i_k_cc_a_3__6(this.mSheet);
	}
	if (id == 'k.cc.a.3_7')
	{
		return new i_k_cc_a_3__7(this.mSheet);
	}
	if (id == 'k.cc.a.3_8')
	{
		return new i_k_cc_a_3__8(this.mSheet);
	}
	if (id == 'k.cc.a.3_9')
	{
		return new i_k_cc_a_3__9(this.mSheet);
	}
	if (id == 'k.cc.a.3_10')
	{
		return new i_k_cc_a_3__10(this.mSheet);
	}
	if (id == 'k.cc.a.3_11')
	{
		return new i_k_cc_a_3__11(this.mSheet);
	}
	if (id == 'k.cc.a.3_12')
	{
		return new i_k_cc_a_3__12(this.mSheet);
	}
	if (id == 'k.cc.a.3_13')
	{
		return new i_k_cc_a_3__13(this.mSheet);
	}
	if (id == 'k.cc.a.3_14')
	{
		return new i_k_cc_a_3__14(this.mSheet);
	}
	if (id == 'k.cc.a.3_15')
	{
		return new i_k_cc_a_3__15(this.mSheet);
	}
	if (id == 'k.cc.a.3_16')
	{
		return new i_k_cc_a_3__16(this.mSheet);
	}
	if (id == 'k.cc.a.3_17')
	{	
		return new i_k_cc_a_3__17(this.mSheet);
	}
	if (id == 'k.cc.a.3_18')
	{
		return new i_k_cc_a_3__18(this.mSheet);
	}
	if (id == 'k.cc.a.3_19')
	{
		return new i_k_cc_a_3__19(this.mSheet);
	}
	if (id == 'k.cc.a.3_20')
	{
		return new i_k_cc_a_3__20(this.mSheet);
	}
	if (id == 'k.cc.a.3_21')
	{
		return new i_k_cc_a_3__21(this.mSheet);
	}
	...
	//-----------4th GRADE---------
        ...
        if (id == '4.oa.a.2_16')
        {
                return new i_4_oa_a_2__16(this.mSheet);
       	} 
        if (id == '4.oa.a.2_17')
        {
                return new i_4_oa_a_2__17(this.mSheet);
        }
        if (id == '4.oa.a.2_18')
        {
                return new i_4_oa_a_2__18(this.mSheet);
        }
        if (id == '4.oa.a.2_19')
        {
                return new i_4_oa_a_2__19(this.mSheet);
        }
        if (id == '4.oa.a.2_20')
        {
                return new i_4_oa_a_2__20(this.mSheet);
        }
        if (id == '4.oa.a.2_21')
        {
                return new i_4_oa_a_2__21(this.mSheet);
        }
        if (id == '4.oa.a.2_22')
        {
                return new i_4_oa_a_2__22(this.mSheet);
        }
        if (id == '4.oa.a.2_23')
        {
