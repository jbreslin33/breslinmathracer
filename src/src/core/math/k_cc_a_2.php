...
/*
insert into item_types(id,progression,core_standards_id,description) values ('k.cc.a.2_11',0.0211,'k.cc.a.2','What comes next when counting by ten from numbers that end in zero from 10 to 100.');
*/
var i_k_cc_a_2__11 = new Class(
{
