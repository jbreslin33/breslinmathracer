...
initialize: function(sheet)
{
	...
	while (na <= da || nb >= db)
        ...
        var answerTemp = new Fraction(parseInt(na*nb),parseInt(da*db),true);
...
initialize: function(sheet)
{
        ...
        this.setAnswer('' + answer.getString(),0);
        this.setQuestion('' + this.ns.mNameOne + ' bought ' + a + ' ' + this.ns.mVegetableOne + '. ' +  this.ns.mNameMachine.getPronoun(this.ns.mNameOne,0,1) + ' ' + this.ns.mFamilyOne +  ' ate ' +  fractionb.getString() + ' of them. How many ' + this.ns.mVegetableOne + ' did ' + this.ns.mNameMachine.getPronoun(this.ns.mNameOne,0,1) + ' ' + this.ns.mFamilyOne + ' eat?');
}
});
