...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nf.b.3.b_3',4.1503,'4.nf.b.3.b','find missing numerator');
*/

var i_4_nf_b_3_b__3 = new Class(
{
