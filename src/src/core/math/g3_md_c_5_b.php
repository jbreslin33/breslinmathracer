...
/*
insert into item_types(id,progression,core_standards_id,description) values ('3.md.c.5.b_3',3.2503,'3.md.c.5.b','' ); update item_types SET progression = 3.2503 where id = '3.md.c.5.b_3';
*/
