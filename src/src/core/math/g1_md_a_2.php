...
/*
insert into item_types(id,progression,core_standards_id,description) values ('1.md.a.2_2',1.1902,'1.md.a.2','');
*/
var i_1_md_a_2__2 = new Class(
{
Extends: TextItem,
...
initialize: function(sheet)
{
	...
	this.ns = new NameSampler();
        ...
        this.mType = '1.md.a.2_1';
     	...
     	this.x = Math.floor(Math.random()*3)+3;
	this.x1 = parseInt(this.x * 50);
