...
Extends: TextItem,
        initialize: function(sheet)
        {
                ...
                this.mType = '4.md.a.1_17';

                this.setQuestion('How many grams in a kilogram?');
                this.setAnswer('' + 1000,0);
        }
});

/*
insert into item_types(id,progression,core_standards_id,description) values ('4.md.a.1_16',4.2416,'4.md.a.1','');
*/
var i_4_md_a_1__16 = new Class(
{
Extends: TextItem,
        initialize: function(sheet)
        {
                ...
                this.mType = '4.md.a.1_16';

                this.setQuestion('How many mililiters in a liter?');
                this.setAnswer('' + 1000,0);
        }
});

/*
insert into item_types(id,progression,core_standards_id,description) values ('4.md.a.1_15',4.2415,'4.md.a.1','');
*/
var i_4_md_a_1__15 = new Class(
{
Extends: TextItem,
        initialize: function(sheet)
        {
                ...
                this.mType = '4.md.a.1_15';

                this.setQuestion('How many milimeters in a centimeter?');
                this.setAnswer('' + 10,0);
        }
});
...
Extends: TextItem,
        initialize: function(sheet)
        {
                ...
                this.setQuestion('How many centimeters in a meter?');
...
Extends: TextItem,
        initialize: function(sheet)
        {
                ...
                this.setQuestion('How many meters in a kilometer?');
                this.setAnswer('' + 1000,0);
        }
});
