...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.md.c.6_2',4.3002,'4.md.c.6',''); update item_types SET progression = 4.3002 where id = '4.md.c.6_2';
*/
...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.md.c.6_1',4.3001,'4.md.c.6',''); update item_types SET progression = 4.3001 where id = '4.md.c.6_1';
*/
