...
/*
insert into item_types(id,progression,core_standards_id,description) values ('1.nbt.b.3_4',1.1404,'1.nbt.b.3','');
*/
var i_1_nbt_b_3__4 = new Class(
{
...
initialize: function(sheet)
{
	...
	while (this.tensB <= this.tensA || this.onesB >= this.onesA)
	{	
