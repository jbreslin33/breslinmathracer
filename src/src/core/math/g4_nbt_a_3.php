...
//9 
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.a.3_17',4.0817,'4.nbt.a.3','1,000');
*/
...
initialize: function(sheet)
{
        ...
        //b
        var numberB                = parseInt(hundredthousands * 100000 + tenthousands * 10000 + (thousands + 1) * 1000);
...
//8
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.a.3_16',4.0816,'4.nbt.a.3','1,000');
*/
var i_4_nbt_a_3__16 = new Class(
{
Extends: TextItem,
...
initialize: function(sheet)
{
        ...
        var tenthousands     = Math.floor(Math.random()*9)+1;
        var thousands        = 0;
        var hundreds         = Math.floor(Math.random()*5);
        var tens             = Math.floor(Math.random()*10);
        var ones             = Math.floor(Math.random()*10);
        ...
        //b
        var numberB                = parseInt(hundredthousands * 100000 + tenthousands * 10000 + thousands * 1000);
...
//7
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.a.3_15',4.0815,'4.nbt.a.3','1,000');
*/
...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.a.3_14',4.0814,'4.nbt.a.3','10,000');
*/
