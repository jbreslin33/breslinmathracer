...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.md.c.5.b_2',4.2902,'4.md.c.5.b',''); update item_types SET progression = 4.2902 where id = '4.md.c.5.b_2';
*/
...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.md.c.5.b_1',4.2901,'4.md.c.5.b',''); update item_types SET progression = 4.2901 where id = '4.md.c.5.b_1';
*/
