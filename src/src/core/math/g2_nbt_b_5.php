...
/*
insert into item_types(id,progression,core_standards_id,description) values ('2.nbt.b.5_5',2.1105,'2.nbt.b.5','2x2 carry'); update item_types SET progression = 2.1105 where id = '2.nbt.b.5_5';
*/

var i_2_nbt_b_5__5 = new Class(
{
Extends: TextItem,
...
/*
insert into item_types(id,progression,core_standards_id,description) values ('2.nbt.b.5_4',2.1104,'2.nbt.b.5','2x2 carry'); update item_types SET progression = 2.1104 where id = '2.nbt.b.5_4';
*/

var i_2_nbt_b_5__4 = new Class(
{
Extends: TextItem,
initialize: function(sheet)
{
