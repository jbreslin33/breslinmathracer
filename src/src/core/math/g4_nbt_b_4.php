...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.b.4_14',4.0914,'4.nbt.b.4','100000-100000');
*/

var i_4_nbt_b_4__14 = new Class(
{
Extends: TextItem,
initialize: function(sheet)
{
        ...
        while (a < b)
        {
                a = Math.floor(Math.random()*899999)+100000;
                b = Math.floor(Math.random()*899999)+100000;
        }
...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.b.4_13',4.0913,'4.nbt.b.4','100000-10000');
*/

var i_4_nbt_b_4__13 = new Class(
{
Extends: TextItem,
initialize: function(sheet)
{
        ...
        {
                a = Math.floor(Math.random()*899999)+100000;
                b = Math.floor(Math.random()*89999)+10000;
        }
...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.b.4_12',4.0912,'4.nbt.b.4','100000-1000');
*/

var i_4_nbt_b_4__12 = new Class(
{
Extends: TextItem,
initialize: function(sheet)
{
...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.b.4_11',4.0911,'4.nbt.b.4','10000-10000');
*/

var i_4_nbt_b_4__11 = new Class(
{
Extends: TextItem,
initialize: function(sheet)
{
        ...
        while (a < b)
        {
                a = Math.floor(Math.random()*89999)+10000;
                b = Math.floor(Math.random()*89999)+10000;
        }
...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.b.4_10',4.0910,'4.nbt.b.4','10000-1000');
*/

var i_4_nbt_b_4__10 = new Class(
{
Extends: TextItem,
initialize: function(sheet)
{
