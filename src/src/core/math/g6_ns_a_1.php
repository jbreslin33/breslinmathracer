...
/*
insert into item_types(id,progression,core_standards_id,description) values ('6.ns.a.1_6',6.706,'6.ns.a.1','word problem. divide mixed number by a mixed number');
*/
