...
/*
insert into item_types(id,progression,core_standards_id,description) values ('5.nf.b.5.b_1',5.1901,'5.nf.b.5.b','');
*/
var i_5_nf_b_5_b__1 = new Class(
{
Extends: ThreeButtonItem,
        initialize: function(sheet)
        {
                this.parent(sheet);
                this.mType = '5.nf.b.5.b_1';
