...
initialize: function(sheet)
{
	...
	while (this.tenthousandsA == this.tenthousandsB)
	{
	...
	//A
        this.tenthousands_thousands = parseInt(this.tenthousandsA * 10000 + this.thousandsA * 1000);
        this.tens_ones              = parseInt(this.tensA * 10 + this.onesA);
        this.numberA                = parseInt(this.hundredthousands * 100000 + this.tenthousands_thousands + this.hundredsA * 100 + this.tens_ones);

	//B
        this.tenthousands_thousands = parseInt(this.tenthousandsB * 10000 + this.thousandsB * 1000);
        this.tens_ones              = parseInt(this.tensB * 10 + this.onesB);
        this.numberB                = parseInt(this.hundredthousands * 100000 + this.tenthousands_thousands + this.hundredsB * 100 + this.tens_ones);
        ...
        this.setQuestion('Compare.');
	if (this.tenthousandsA > this.tenthousandsB)
	{
        	this.setAnswer('&gt;',0);
	}
	else
...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.a.2_59',4.0759,'4.nbt.a.2','compare hundreds');
*/
var i_4_nbt_a_2__59 = new Class(
{
Extends: ThreeButtonItem,
initialize: function(sheet)
{
        this.parent(sheet);
      	this.mType = '4.nbt.a.2_59';
	...
	while (this.thousandsA == this.thousandsB)
	{
        	this.hundredthousands = Math.floor((Math.random()*8)+1);
	...
	//B
        this.tenthousands_thousands = parseInt(this.tenthousands * 10000 + this.thousandsB * 1000);
        this.tens_ones              = parseInt(this.tensB * 10 + this.onesB);
        this.numberB                = parseInt(this.hundredthousands * 100000 + this.tenthousands_thousands + this.hundredsB * 100 + this.tens_ones);
        ...
        this.setQuestion('Compare.');
	if (this.thousandsA > this.thousandsB)
	{
        	this.setAnswer('&gt;',0);
	}
	else
...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.a.2_58',4.0758,'4.nbt.a.2','compare hundreds');
*/
var i_4_nbt_a_2__58 = new Class(
{
Extends: ThreeButtonItem,
initialize: function(sheet)
{
        this.parent(sheet);
      	this.mType = '4.nbt.a.2_58';
	...
	while (this.hundredsA == this.hundredsB)
	{
        	this.hundredthousands = Math.floor((Math.random()*8)+1);
        	this.tenthousands     = Math.floor((Math.random()*8)+1); 
	...
	//B
        ...
        this.setQuestion('Compare.');
	if (this.hundredsA > this.hundredsB)
	{
        	this.setAnswer('&gt;',0);
	}
	else
...
initialize: function(sheet)
{
        ...
        this.setQuestion('Write the number in standard form: ' + parseInt(this.hundredthousands * 100000) + '+' + parseInt(this.tens * 10) + '+' + this.ones,0);
...
initialize: function(sheet)
{
        ...
        this.setQuestion('' + this.ns.mNameOne + ' says ' + this.ns.mNameMachine.getPronoun(this.ns.mNameOne,0,0) + ' scored ' + this.ns.mNameMachine.getNumberName(this.hundredthousands) + ' hundred ' + 'thousand ' + this.ns.mNameMachine.getNumberName(this.tens_ones) + ' points in ' + this.ns.mVideoGameOne + '. Write that number in standard form.',0);
        this.setAnswer('' + this.number,0);
}
});
...
//52,53
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.a.2_53',4.0753,'4.nbt.a.2','');
*/
var i_4_nbt_a_2__53 = new Class(
{
Extends: TextItem,
...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.a.2_52',4.0752,'4.nbt.a.2','');
*/
var i_4_nbt_a_2__52 = new Class(
{
Extends: TextItem,
...
initialize: function(sheet)
{
        ...
        this.setQuestion('The population of the town ' + this.ns.mNameOne + ' lives in is ' + parseInt(this.hundredthousands * 100000) + '+' + parseInt(this.tenthousands * 10000) + '+' + parseInt(this.thousands * 1000) + '+' + parseInt(this.hundreds * 100) + '+' + this.ones + '. Write the population number in standard form.',0);
        this.setAnswer('' + this.number,0);
}
});
...
/*
insert into item_types(id,progression,core_standards_id,description) values ('4.nbt.a.2_49',4.0749,'4.nbt.a.2','');
*/
var i_4_nbt_a_2__49 = new Class(
{
Extends: TextItem,
...
initialize: function(sheet)
{
        ...
        this.setQuestion('' + 'The area of the state ' + this.ns.mNameOne + ' lives in is ' + this.ns.mNameMachine.getNumberName(this.hundredthousands) + ' hundred ' + this.ns.mNameMachine.getNumberName( parseInt(this.tenthousands * 10 + this.thousands)) + ' thousand ' + this.ns.mNameMachine.getNumberName(this.hundreds) + ' hundred ' + this.ns.mNameMachine.getNumberName(this.tens_ones) + ' square miles. Write the amount of square miles in standard form.',0);
        this.setAnswer('' + this.number,0);
}
});
