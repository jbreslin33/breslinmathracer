...
/*
insert into item_types(id,progression,core_standards_id,description) values ('5.nbt.a.4_9',5.0809,'5.nbt.a.4','nines round to tenths ');
*/
var i_5_nbt_a_4__9 = new Class(
{
Extends: TextItem,
...
initialize: function(sheet)
{
        ...
        this.tenths      = Math.floor((Math.random()*8)+1);
