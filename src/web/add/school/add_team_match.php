...
$q = "select matches.id, teams.name, matches.start_time, matches.end_time from matches JOIN teams_matches ON matches.id=teams_matches.matches_id JOIN teams ON teams_matches.team_id=teams.id where matches.school_id = ";
