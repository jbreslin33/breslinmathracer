...
<p><b> Homework Grades </p></b>

<p><b> Select Room and Student: </p></b>
<form method="post" action="/web/reports/generic/homework_grades.php">
...
function loadAgain()
{
	...
	document.location.href = '/web/reports/generic/homework_grades.php?room_id=' + x + '&user_id=' + y; 
}
</script>
...
else
{
	...
	$gradeTxt = "Average Homework Grade: ";
