...
<p><b> Select Room, Student and Homework: </p></b>

<form method="post" action="/web/reports/generic/homeworks.php">
...
$query .= $user_id;
$query .= " AND (evaluations_id = 17 OR evaluations_id = 18) order by start_time desc;";
$result = pg_query($conn,$query);
$numrows = pg_numrows($result);

echo "<option selected=\"selected\" value=\"0\"> \"Select Homework\" </option>";
...
function loadAgain()
{
	...
	document.location.href = '/web/reports/generic/homeworks.php?room_id=' + x + '&user_id=' + y + '&test_id=' + z; 
}
</script>
