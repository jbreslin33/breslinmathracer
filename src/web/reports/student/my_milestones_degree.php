...
echo '<table border=\"1\">';
        ...
        echo '</td>';
        echo '<td>t<br>i<br>n<br>y<br>1<br>s';
        echo '</td>';
        echo '<td>t<br>i<br>n<br>y<br>2<br>s';
        echo '</td>';
        echo '<td>t<br>i<br>n<br>y<br>3<br>s';
        echo '</td>';
        echo '<td>m<br>i<br>n<br>i<br>m<br>i<br>n<br>u<br>s<br>1<br>s';
        echo '</td>';
        echo '<td>m<br>i<br>n<br>i<br>m<br>i<br>n<br>u<br>s<br>2<br>s';
        echo '</td>';
        echo '<td>m<br>i<br>n<br>i<br>m<br>i<br>n<br>u<br>s<br>3<br>s';
        echo '</td>';
	...
	echo '<td>3<br> o<br>a<br> c<br> 7';
        ...
        echo '</td>';
        //echo '<td>N<br>O<br> <br>0<br> <br>D<br>I<br>V<br>I<br>S<br>I<br>O<br>N';
        echo '<td>N<br>O<br> <br>0<br> <br>D<br>I<br>V';
        echo '</td>';
        echo '<td>0<br> <br>I<br>N<br> <br>2<br>n<br>d<br> <br>D<br>I<br>V';
        echo '</td>';
        echo '<td>0<br> <br>I<br>N<br> <br>3<br>r<br>d<br> <br>D<br>I<br>V';
        echo '</td>';
        echo '<td>0<br> <br>I<br>N<br> <br>4<br>t<br>h<br> <br>D<br>I<br>V';
        echo '</td>';
...
COUNT(CASE WHEN item_attempts.transaction_code = 1 then 1 ELSE NULL END) as correct, COUNT(CASE WHEN item_attempts.transaction_code = 0 then 1 ELSE NULL END) + COUNT(CASE WHEN item_attempts.transaction_code = 1 then 1 ELSE NULL END) + COUNT(CASE WHEN item_attempts.transaction_code = 2 then 1 ELSE NULL END) as total_answered,";
	...
	$query_m .= " COUNT(CASE WHEN item_attempts.transaction_code = 1 then 1 ELSE NULL END) / (COUNT(CASE WHEN item_attempts.transaction_code = 0 then 1 ELSE NULL END) + COUNT(CASE WHEN item_attempts.transaction_code = 1 then 1 ELSE NULL END) + COUNT(CASE WHEN item_attempts.transaction_code = 2 then 1 ELSE NULL END))::float * 100 as inner_grade   from evaluations_attempts join users on evaluations_attempts.user_id=users.id JOIN item_attempts ON item_attempts.evaluations_attempts_id=evaluations_attempts.id JOIN evaluations ON evaluations.id=evaluations_attempts.evaluations_id where evaluations_attempts.start_time > '2018-09-01 09:28:27.777635' AND evaluations_attempts.evaluations_id != 1 "; 
